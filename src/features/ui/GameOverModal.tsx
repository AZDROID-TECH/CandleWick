        ...
        <div className="absolute inset-0 flex items-center justify-center z-50 bg-black/80 backdrop-blur-md p-6">
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <button className="w-full py-3 bg-slate-700 hover:bg-slate-600 rounded-lg font-bold text-white flex items-center justify-center gap-2" disabled>
                        <i className='bx bxs-video text-white'></i> {t('watch_ad')} (3)
                    </button>
                    <button
